                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="{{ route('home') }}" class="app-brand-link gap-2">
                                <img src="{{ asset('sneat/img/ss.png') }}" alt="{{ config('app.name') }}" srcset="" width="75px">
                            </a>
                        </div>
                        <div>
                            <center>
                        ...
                        <form id="formAuthentication" class="mb-3" action="{{ route('forgot-password-act') }}" method="post">
                            @csrf
